...
public class insertNewResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String MTC=jTextField3.getText();
        String SST=jTextField4.getText();
        String SCI=jTextField5.getText();
        try{
            ...
            if(rs.next())
            {
                st.executeUpdate("insert into result(RegNo,ENG,MTC,SST,SCI) values('"+RegNo+"','"+ENG+"','"+MTC+"','"+SST+"','"+SCI+"') ");
            ...
            {
                JOptionPane.showMessageDialog(null,"Registration Number Doesn't Exist In Database");
                setVisible(false);
                new insertNewResult().setVisible(true);
            }
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRSimport java.sql.*;
import javax.swing.JOptionPane;
/*
 * Click nbfs://nbhost/SystemFileSystem/Templates/Licenses/license-default.txt to change this license
 * Click nbfs://nbhost/SystemFileSystem/Templates/GUIForms/JFrame.java to edit this template
